...
const bannedWords = ["f**k", "sh*t", "a**hole", "b**ch", "d**k", "c**t", "b**tard", "b**ls", "n****r", "sp*c", "ch*nk", "k*ke", "w*tback", "p*ssy", "c*ck", "d**do", "f*ggot", "tw*t", "r*tard", "m*ron", "d**chebag", "sc*mbag", "c*ke", "m*th", "h*roin", "cr*ck", "sl*t", "wh*re", "tr*mp",'damn', 'hell', 'crap', 'ass', 'bitch', 'bastard', 'dick', 'pussy', 'slut', 'whore',
    'cunt', 'fuck', 'shit', 'piss', 'tits', 'nigger', 'fag', 'retard', 'lame', 'idiot',
    'moron', 'stupid', 'dumb', 'loser', 'weirdo'];
...
const EnterConference = () => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            const res = await axios.post(`http://https://conferencebackend.onrender.com/api/conferences/${id}/chats`, { message: newMessage }, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
